    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-20 items-center justify-between">
            ...
            <div class="flex items-center gap-x-6 justify-center">
                @guest
                <div class="flex gap-x-5 items-center align-middle justify-center">
            ...
            <a href="{{ route('login') }}" class="text-sm font-bold leading-6 text-white bg-emerald-700 px-8 py-2 rounded-full">Log in</a>
            @else
